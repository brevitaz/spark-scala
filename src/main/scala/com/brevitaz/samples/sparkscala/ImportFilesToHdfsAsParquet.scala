...
object ImportFilesToHdfsAsParquet extends SparkSessionWrapper{
  ...
  def main(args: Array[String]) {
    ...
    val outFile = s"$outFs/Crimes.parquet"
    ...
    ds.write.mode(SaveMode.Overwrite).partitionBy("year").parquet(outFile)
